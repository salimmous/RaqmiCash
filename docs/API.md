...
- **Base URL:** `https://app.jebab.com/api`
- **Format:** JSON
...
const login = async (email, password) => {
  const response = await fetch('https://app.jebab.com/api/login', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
const createRecharge = async (token, operator, phone, amount) => {
  const response = await fetch('https://app.jebab.com/api/recharges', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Bearer ${token}`,
...
```php
// Login
$ch = curl_init('https://app.jebab.com/api/login');
...
// Créer une recharge
$ch = curl_init('https://app.jebab.com/api/recharges');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_POST, true);
curl_setopt($ch, CURLOPT_POSTFIELDS, json_encode([
    'operator' => 'IAM',
...
# Login
response = requests.post('https://app.jebab.com/api/login', json={
    'email': 'user@example.com',
    'password': 'password'
})
...
response = requests.post(
    'https://app.jebab.com/api/recharges',
