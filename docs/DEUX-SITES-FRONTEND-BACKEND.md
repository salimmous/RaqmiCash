...
| **Exemples**   | jebab.com, www         | app.jebab.com, platform…   |
...
1. **Nom exact du Site 1** (frontend) : ex. `jebab.com`, `www.jebab.com`.
2. **Nom exact du Site 2** (backend) : ex. `app.jebab.com`, `platform.jebab.com`, ou domaine séparé.
